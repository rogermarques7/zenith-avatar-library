...
| `f_b03_d2` | ⛔ **INERTE — não usar como está.** *"Magra e levemente atlética. Ombros com forma discreta, coxas e glúteos com leve tônus, abdômen plano sem gomos, cintura fina."* É string de adjetivo, da mesma safra do `f_b07_d3` velho: em 30/07 devolveu a âncora reescalada (razões paradas, §1.4b). **Substituto testado: "BAILARINA CLÁSSICA DE COMPANHIA PROFISSIONAL"** — acerta a forma (`cintura/ombro` 0,587 → 0,549) mas carrega um corpo mais LEVE que 18,3. Ao retomar, usar essa categoria com âncora `zen_f_b04_d2` (22,2). |
